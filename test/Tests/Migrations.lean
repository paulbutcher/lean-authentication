...
private def federationLinkDown : String :=
  include_str "../../migrations/sqlite/20260915120000_authentication_federation_link.down.sql"

private def federationInvitationDown : String :=
  include_str "../../migrations/sqlite/20260914120000_authentication_federation_invitation.down.sql"

private def federationDown : String :=
  include_str "../../migrations/sqlite/20260911120000_authentication_federation.down.sql"
...
private def down : String :=
  federationLinkDown ++ federationInvitationDown ++ federationDown ++ oauthDown ++ consentDown
    ++ suppressionDown ++ rateCountersDown ++ initialDown
