...
- `Credential` carries a typed descriptor rather than a kind and a string.
- `AuthStore` gains linked identities, verified addresses and the state record of AUTH-6.2, with migrations for both backends and a `duplicateEmail` refusal.
